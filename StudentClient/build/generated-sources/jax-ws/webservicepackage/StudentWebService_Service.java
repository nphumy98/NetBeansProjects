 ...
 * 
 */
@WebServiceClient(name = "StudentWebService", targetNamespace = "http://WebServicePackage/", wsdlLocation = "http://localhost:8080/StudentServer/StudentWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTWEBSERVICE_QNAME = new QName("http://WebServicePackage/", "StudentWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/StudentServer/StudentWebService?wsdl");
    ...
    public StudentWebService getStudentWebServicePort() {
        return super.getPort(new QName("http://WebServicePackage/", "StudentWebServicePort"), StudentWebService.class);
    }
    ...
    public StudentWebService getStudentWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WebServicePackage/", "StudentWebServicePort"), StudentWebService.class, features);
    }
